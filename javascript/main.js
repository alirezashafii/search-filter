...
lightSwitch.addEventListener("click", () => {
  if (document.body.classList.contains("dark")) {
    ...
    document.querySelector("header section").style.backgroundColor = `#f8fafc`;
    document.querySelector("header input").style.backgroundColor = `#fff`;
  } else {
    lightSwitch.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                            </svg>`;
    document.querySelector("header section").style.backgroundColor = `#111111`;
    document.querySelector("header input").style.backgroundColor = `#121314`;
  }
